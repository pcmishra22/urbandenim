...
@section('title', 'Shop - Urban Denim')
...
<div class="bg0 m-t-23 p-b-140">
    <div class="container">
                ...
                <div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
                    <div class="filter-col1 p-r-15 p-b-27">
                        ...
                        <ul>
                            ...
                            <li class="p-b-6"><a href="#" class="filter-link stext-106 trans-04">Newness</a></li>
                    ...
                    <div class="filter-col2 p-r-15 p-b-27">
                        ...
                        <ul>
                            ...
                            <li class="p-b-6"><a href="#" class="filter-link stext-106 trans-04">$100.00+</a></li>
                        </ul>
                    </div>
        ...
        <div class="row isotope-grid">
                    ...
                    <div class="block2-txt flex-w flex-t p-t-14">
                        ...
                        <div class="block2-txt-child2 flex-r p-t-3">
                            <a href="#" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2">
                                ...
                                <img class="icon-heart2 dis-block trans-04 pos-absolute" src="{{ asset('themes/cozastore/assets/images/icons/icon-heart-02.png') }}" alt="ICON">
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <!-- More product blocks would be repeated here -->
        </div>
