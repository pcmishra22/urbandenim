...
<head>
    ...
    <title>Urban Denim - Multi-Role Authentication</title>
    ...
    <style>
        ...
        .customer-icon { color: var(--customer-color); }
        .vendor-icon { color: var(--vendor-color); }
...
<body>
    <div class="hero-container">
        ...
        <h1>Urban Denim</h1>
        <p class="subtitle">Multi-Role Authentication System</p>
        ...
        <div class="roles-container">
            ...
            <div class="role-card">
                ...
                <p class="role-description">Shop products, place orders, and track your purchases</p>
            ...
            <div class="role-card">
                ...
                <p class="role-description">Manage your products, inventory, and sales</p>
                <a href="{{ route('vendor.login') }}" class="btn-login">
                    <i class="fas fa-sign-in-alt"></i> Login
                </a>
                <a href="{{ route('vendor.register') }}" class="btn-register">
                    <i class="fas fa-user-plus"></i> Register
                </a>
            </div>
            ...
            <div class="role-card">
                ...
                <p class="role-description">Full control over the entire system</p>
