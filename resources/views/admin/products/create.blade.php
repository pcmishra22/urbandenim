                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('fit_type') is-invalid @enderror" 
                            ...
                            <option value="">-- Select --</option>
                            <option value="slim" @selected(old('fit_type') == 'slim')>Slim</option>
                            <option value="regular" @selected(old('fit_type') == 'regular')>Regular</option>
                            <option value="baggy" @selected(old('fit_type') == 'baggy')>Baggy</option>
                            <option value="skinny" @selected(old('fit_type') == 'skinny')>Skinny</option>
                            <option value="straight" @selected(old('fit_type') == 'straight')>Straight</option>
                        </select>
                        @error('fit_type')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
