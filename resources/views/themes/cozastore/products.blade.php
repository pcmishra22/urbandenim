...
@section('content')
    <div class="container">
        <div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
            ...
            <span class="stext-109 cl4">Products</span>
        </div>
    </div>

    <!-- Product listing / Category listing placeholder (HTML-first) -->
        ...
        <div class="container">
            <div class="flex-w flex-sb-m p-b-52">
                <div class="flex-w flex-l-m filter-tope-group m-tb-10">
                    ...
                    <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".women">Men Jeans</button>
                    <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".men">Women Jeans</button>
                    <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".kids">Kids Jeans</button>
                </div>

                <!-- Right controls: Sorting/Pagination/Search/Filters UI (static for now) -->
            ...
            <div class="row isotope-grid">
                <!-- Static product cards (HTML-first) -->
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">
                    <div class="block2">
                        <div class="block2-pic hov-img0">
                            <img src="{{ asset('themes/cozastore/assets/images/product-01.jpg') }}" alt="IMG-PRODUCT">
                        ...
                        <div class="block2-txt flex-w flex-t p-t-14">
                            <div class="block2-txt-child1 flex-col-l">
                                <a href="/products/sample" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">Men Jeans 01</a>
                                <span class="stext-105 cl3">$16.64</span>
                            </div>
                            <div class="block2-txt-child2 flex-r p-t-3">
                                <a href="#" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2">
                                    <img class="icon-heart1 dis-block trans-04" src="{{ asset('themes/cozastore/assets/images/icons/icon-heart-01.png') }}" alt="ICON">
                                    <img class="icon-heart2 dis-block trans-04 ab-t-l" src="{{ asset('themes/cozastore/assets/images/icons/icon-heart-02.png') }}" alt="ICON">
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                    <div class="block2">
                        <div class="block2-pic hov-img0">
                            <img src="{{ asset('themes/cozastore/assets/images/product-02.jpg') }}" alt="IMG-PRODUCT">
                            <a href="#" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">Quick View</a>
                        </div>
                        <div class="block2-txt flex-w flex-t p-t-14">
                            <div class="block2-txt-child1 flex-col-l">
                                <a href="/products/sample" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">Women Jeans 02</a>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item kids">
                    <div class="block2">
                        <div class="block2-pic hov-img0">
                            <img src="{{ asset('themes/cozastore/assets/images/product-03.jpg') }}" alt="IMG-PRODUCT">
                            <a href="#" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">Quick View</a>
                        </div>
                        <div class="block2-txt flex-w flex-t p-t-14">
                            <div class="block2-txt-child1 flex-col-l">
                                <a href="/products/sample" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">Kids Jeans 03</a>
