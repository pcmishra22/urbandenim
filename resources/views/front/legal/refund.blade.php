...
@section('meta_description', 'Jeanzo offers a 7-day hassle-free return policy. Learn how to return items, eligibility criteria and refund timelines.')
@section('canonical', route('legal.refund'))
@section('meta_robots', 'noindex, follow')
@section('og_title', 'Return &amp; Refund Policy — Jeanzo')
@section('og_description', 'Jeanzo offers a 7-day hassle-free return policy. Learn how to return items, eligibility criteria and refund timelines.')
@section('content')
