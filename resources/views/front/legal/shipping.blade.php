...
@section('meta_description', 'Free shipping above ₹999. Pan-India delivery in 3-7 business days. Jeanzo shipping charges and timelines.')
@section('canonical', route('legal.shipping'))
@section('meta_robots', 'noindex, follow')
@section('og_title', 'Shipping Policy — Jeanzo')
@section('og_description', 'Free shipping above ₹999. Pan-India delivery in 3-7 business days. Jeanzo shipping charges and timelines.')
@section('content')
