...
@section('meta_description', 'Learn how to cancel your Jeanzo order before dispatch. Full refund on cancellation. No questions asked.')
@section('canonical', route('legal.cancellation'))
@section('meta_robots', 'noindex, follow')
@section('og_title', 'Cancellation Policy — Jeanzo')
@section('og_description', 'Learn how to cancel your Jeanzo order before dispatch. Full refund on cancellation. No questions asked.')
@section('content')
