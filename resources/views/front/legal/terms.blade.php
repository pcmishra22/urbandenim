...
@section('meta_description', 'Read Jeanzo's Terms & Conditions governing the use of our website, purchases, payments and delivery.')
@section('canonical', route('legal.terms'))
@section('meta_robots', 'noindex, follow')
@section('og_title', 'Terms &amp; Conditions — Jeanzo')
@section('og_description', 'Read Jeanzo's Terms & Conditions governing the use of our website, purchases, payments and delivery.')
@section('content')
