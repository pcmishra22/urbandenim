...
@section('meta_description', 'Learn how Jeanzo collects, uses and protects your personal data. We are committed to your privacy and data security.')
@section('canonical', route('legal.privacy'))
@section('meta_robots', 'noindex, follow')
@section('og_title', 'Privacy Policy — Jeanzo')
@section('og_description', 'Learn how Jeanzo collects, uses and protects your personal data. We are committed to your privacy and data security.')
@section('content')
