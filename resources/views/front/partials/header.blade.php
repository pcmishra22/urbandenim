...
<head>
    ...
    <meta name="twitter:site" content="@{{ 'jeanzo_in' }}">
...
<!-- PROMO BAR -->
<div id="promo-bar">
    🚚 FREE Shipping on Every Order &nbsp;|&nbsp; <strong>Special Launch Offer: Flat Discount for a Limited Time</strong>  &nbsp;|&nbsp; <a href="{{ route('products.index') }}">Shop Now →</a>
</div>
